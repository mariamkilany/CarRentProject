    ...
    <div>
      <div className="landingSection">
        <div className="headerText">
          ...
          <p>
            Discover a world of possibilities with our extensive fleet of
            top-quality vehicles. Whether you're planning a road trip, a
            business trip, or just need a ride around town, we've got the
            perfect car for you.
          </p>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={4}>
            <div className="choosing">
              <ToysIcon
                sx={{ color: "var(--clr-m-800)", fontSize: "6.5rem" }}
              ></ToysIcon>
