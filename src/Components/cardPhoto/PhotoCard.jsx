			...
			<Grid container spacing={2} mt={2}>
				<Grid item xs={4}>
					<Box
						...
						onClick={e => setSelectedImg({ id: e.target.id, src: e.target.src })}
					>
						<Box p={3} className={`${styles.gallary_item} ${styles.first} `}>
							<img src="/images/car-1.png" style={{ marginTop: "30%" }} alt="car-1" id="1" width={"100%"} height={50} />
						</Box>
					</Box>
				</Grid>
				<Grid item xs={4}>
					...
					>
						<Box className={`${styles.gallary_item} `}>
							<img src="/images/car-2.png" id="2" alt="2" width={"100%"} height={130} />
						</Box>
					</Box>
				</Grid>
				<Grid item xs={4}>
					...
					>
						<Box className={`${styles.gallary_item}  `}>
							<img src="/images/car-3.png" id="3" alt="3" width={"100%"} height={130} />
						</Box>
					</Box>
				</Grid>
			</Grid>
