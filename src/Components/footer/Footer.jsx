	...
	return (
		<div
			style={{
				marginTop: "15px",
				width: "100%",
				boxShadow: "0px -7px 4px -1px rgba(0,0,0,0.2), 2px -3px 5px 0px rgba(0,0,0,0.14), 0px 1px 10px 0px rgba(0,0,0,0.12)",
			}}
		>
			<Box>
				<Grid container spacing={1}>
					...
					<Grid container xs={12} md={7} lg={8}>
						<Grid xs={6} lg={3}>
							<ListItemText>
								<Stack id="category-a" sx={{ fontSize: "20px", textAlign: "left", mb: 2 }}>
									<b>About</b>
								</Stack>
								<Stack component="ul">
									...
									<ListItemButton sx={mystyle}>Bussiness Relation</ListItemButton>
								</Stack>
							</ListItemText>
						</Grid>
						<Grid xs={6} lg={3}>
							<ListItemText>
								<Stack id="category-b" sx={{ fontSize: "20px", textAlign: "left", mb: 2 }}>
									<b>Community</b>
								</Stack>
								<Stack component="ul">
						...
						<Grid xs={6} lg={3} sx={{ alignItems: "left" }}>
							<ListItemText>
								<Stack id="category-c" sx={{ fontSize: "20px", textAlign: "left", mb: 2 }}>
									<b>Socials</b>
								</Stack>
					...
					<Stack divider={<Divider orientation="horizontal" color="error"></Divider>}></Stack>
					...
					>
						<Grid sx={{ order: { xs: 2, sm: 1 } }}>
							<Typography sx={{ marginLeft: "80px", fontSize: "15px" }}>©2022 MORENT. All rights reserved</Typography>
						</Grid>
					</Grid>
				</Grid>
			</Box>
